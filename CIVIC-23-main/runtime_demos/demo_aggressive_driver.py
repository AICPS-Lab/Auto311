...
case_report.add_incident_type("aggressive driver")
...
fields_to_collect = []
protocol_path = '../phone_tree/aggressive_driver/protocol.txt'
...
fields = ['Can you describe the vehicle with details like color, year, and make?', 'Can you describe the aggressive behavior observed?']
info = ["white pickup", "he cut in without lights on"]
...
fields = ['Does the driver demonstrate this behavior before?']
info = ["N"]
