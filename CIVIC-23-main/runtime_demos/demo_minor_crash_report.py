...
case_report.add_incident_type("minor crash report")
...
fields = ['Can you describe the vehicle with details like color, year, and make?', 'Is the traffic being blocked?']
info = ["blue toyota", "Y"]
...
fields = ['Is the vehicle still on the scene?']
info = ["N"]
...
fields = ['Where did the vehicle go?']
info = ["interstate 60"]
