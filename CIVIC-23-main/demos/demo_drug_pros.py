...
case_report.add_incident_type("drug pros")
...
fields_to_collect = []
protocol_path = '../phone_tree/drug_pros/protocol.txt'
...
fields = ['Can you describe the suspects?', 'When did this happen?', 'Are there multiple people involved?']
info = ["a bunch of suspicious men", "few minutes ago", "Y"]
...
fields = ['Is there any vehicle involved?']
info = ["N"]
