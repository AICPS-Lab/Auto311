...
case_report.add_incident_type("found property")
...
fields_to_collect = []
protocol_path = '../phone_tree/found_property/protocol.txt'
...
fields = ['Can you describe the property?', 'Are you with the property?']
info = ["a black leather wallet", "Y"]
